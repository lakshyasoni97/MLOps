# 1. Changes in data_manager file. You can add functions for cleaning the data here in data_manager.py file.
...
# apply the above two functions on the dataframe

def get_dataframe_ready(*, dataframe: pd.DataFrame):
